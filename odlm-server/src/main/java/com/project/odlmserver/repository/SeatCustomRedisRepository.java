...
public class SeatCustomRedisRepository {
	...
	public void updateStudyTime(Long seatId, Long studyTime) {
		hashOperations.put("seat:" + seatId, "studyTime", studyTime.toString());
	}
	...
	public void deleteUserId(Long seatId, Long userId) {
		...
		hashOperations.put("seat:" + seatId, "studyTime", "0"); // redis는 숫자 타입 지원x
	}
